...
@Component({
  selector: 'app-csolocation-form',
  templateUrl: './csolocation-form.component.html',
  styleUrls: ['./csolocation-form.component.css']
})
export class CsolocationFormComponent implements OnInit {
